        ...
        if True:
            ...
            for x in i:
                try:
                    ...
                    initCmd = random.choice(["Dwudziestogroszówka", "Dziesięciogroszówka", "Wyselekcjonowany", "Hoży", "Skuwka", "Mżawka", "Horrendalny", "Luminarz", "Pedantyzm", "Wiktuał", "Źdźbło", "Amikoszoneria", "Koafiura", "Frymuśny", "Mitygować", "Paruzja", "Kszyk", "Sukurs", "Defetyzm", "Szczeżuja", "Basałyk", "Anomia", "Kaligynefobia", "Lukarna", "Mitrężąc", "Szaławiła", "Kondotier", "Indolencja", "Prawdopodobnie", "Rozwarstwienie", "Pizza", "Spaghetti", "Miazga", "Zajefajny", "Szczodry", "Niedozwolony", "Przebodźcowany"])
