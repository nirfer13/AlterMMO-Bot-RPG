...
class functions_database(commands.Cog, name="functions_database"):
    ...
    def updateBossTable(dbCursor, BossRarity, respawnTime, ResumeSpawn):
        ...
        print("Time before database write: " + type(Time))
        print("Save resume before database write: " + type(ResumeSpawn))
        print("Boss rarity before database write: " + type(BossRarity))
